...
public class MMInteractiveUser {
	public static void main(String args[]) {
		GenericObject myIntMMObj = new GenericObject(100, "kolgepratik", "May@2015");
		...
		myIntMMObj.setField("Email_Address", "kolge.pratik@gmail.com");

		StringBuffer buffer = new StringBuffer(
				"A spinal tap was performed and oligoclonal bands were detected in the cerebrospinal fluid.\n");
